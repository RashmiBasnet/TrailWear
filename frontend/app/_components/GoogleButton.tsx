...
export default function GoogleButton({ label = "Continue with Google" }: { label?: string }) {
    return (
        <a
            ...
            className="flex w-full items-center justify-center gap-3 rounded-full border border-border bg-white px-6 py-3 text-sm font-semibold text-navy-800 shadow-sm transition hover:bg-navy-50"
        >
            <GoogleLogo />
            {label}
        </a>
